<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="JoleYe.Web.Viewinfo" %>
...
<%
  ...
  templatestr.Append("</div>\r\n");
  templatestr.Append("<div class=\"heng\"></div>\r\n");
  templatestr.Append("<!--头部 over-->\r\n");
  templatestr.Append("<div class=\"tool bd\">目前位置 ：首页 >  <a href=\"listinfo.aspx\">资讯列表 </a> > 正文</div>\r\n");
  templatestr.Append("<div class=\"heng\"></div>\r\n");
  templatestr.Append("<div class=\"body bd\">\r\n");
  templatestr.Append("    <div class=\"left box\">\r\n");
  templatestr.Append("     <div class=\"content viewinfo\">\r\n");
  templatestr.Append("     <div class=\"info_tit\">");
  templatestr.Append(view["articletitle"]);
  templatestr.Append("</div>\r\n");
  templatestr.Append("     <div class=\"info_copy\"><span>发布时间:</span>");
  templatestr.Append(view["createDate"]);
  templatestr.Append("&nbsp;&nbsp;&nbsp;&nbsp;点击:<b>");
  templatestr.Append(view["hitNum"]);
  templatestr.Append("</b></div>\r\n");
  templatestr.Append("        ");
  templatestr.Append(view["content"]);
  templatestr.Append("     </div>\r\n");
  templatestr.Append("     \r\n");
  templatestr.Append("    </div>\r\n");
