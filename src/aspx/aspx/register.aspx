<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="JoleYe.Web.Register" %>
...
<%
  ...
  templatestr.Append("</div>\r\n");
  templatestr.Append("<div class=\"heng\"></div>\r\n");
  templatestr.Append("<div class=\"tool bd\">目前位置 ：首页 > 用户注册</div>\r\n");
  templatestr.Append("<div class=\"heng\"></div>\r\n");
  templatestr.Append("<div class=\"body bd\">\r\n");
  templatestr.Append("	<div class=\"left box\">\r\n");
  templatestr.Append("	    <div class=\"title\">用户注册</div>\r\n");
  ...
  templatestr.Append("      <input type=\"text\" name=\"username\" id=\"username\">\r\n");
  templatestr.Append("    </label></td>\r\n");
  templatestr.Append("  </tr>\r\n");
  templatestr.Append("  <tr>\r\n");
  templatestr.Append("    <td height=\"25\" align=\"right\">密码：</td>\r\n");
  templatestr.Append("    <td><label>\r\n");
  templatestr.Append("      <input name=\"pwd\" type=\"password\" id=\"pwd\" size=\"20\">\r\n");
  templatestr.Append("    </label></td>\r\n");
  templatestr.Append("  </tr>\r\n");
  templatestr.Append("  <tr>\r\n");
  templatestr.Append("    <td height=\"25\" align=\"right\">重复密码：</td>\r\n");
  templatestr.Append("    <td><input name=\"repwd\" type=\"password\" id=\"repwd\" size=\"20\"></td>\r\n");
  templatestr.Append("  </tr>\r\n");
  templatestr.Append("  <tr>\r\n");
  templatestr.Append("    <td height=\"25\" align=\"right\">真实姓名：</td>\r\n");
  templatestr.Append("    <td><label>\r\n");
  templatestr.Append("      <input name=\"truename\" type=\"text\" id=\"truename\" size=\"20\">\r\n");
  templatestr.Append("    </label></td>\r\n");
  templatestr.Append("  </tr>\r\n");
  templatestr.Append("  <tr>\r\n");
  templatestr.Append("    <td height=\"25\" align=\"right\">性别：</td>\r\n");
  templatestr.Append("    <td><label for=\"radio\">\r\n");
  templatestr.Append("      <input name=\"sex\" type=\"radio\" id=\"radio\" value=\"1\" checked>\r\n");
  templatestr.Append("    男</label>\r\n");
  templatestr.Append("    <label for=\"radio2\"><input type=\"radio\" name=\"sex\" id=\"radio2\" value=\"0\">\r\n");
  templatestr.Append("    女</label></td>\r\n");
  templatestr.Append("  </tr>\r\n");
  templatestr.Append("  <tr>\r\n");
  templatestr.Append("    <td height=\"25\" align=\"right\">出生日期：</td>\r\n");
  templatestr.Append("    <td><input name=\"birth\" type=\"text\" id=\"birth\" size=\"20\"></td>\r\n");
  templatestr.Append("  </tr>\r\n");
  templatestr.Append("  <tr>\r\n");
  templatestr.Append("    <td height=\"25\" align=\"right\">邮件：</td>\r\n");
  templatestr.Append("    <td><input type=\"text\" name=\"email\" id=\"email\"></td>\r\n");
  templatestr.Append("  </tr>\r\n");
  templatestr.Append("  <tr>\r\n");
  templatestr.Append("    <td height=\"25\" align=\"right\">联系电话：</td>\r\n");
  templatestr.Append("    <td><input type=\"text\" name=\"telphone\" id=\"telphone\"></td>\r\n");
  templatestr.Append("  </tr>\r\n");
  templatestr.Append("  <tr>\r\n");
  templatestr.Append("    <td height=\"25\" align=\"right\">手机：</td>\r\n");
  templatestr.Append("    <td><input name=\"mobile\" type=\"text\" id=\"mobile\" size=\"20\"></td>\r\n");
  templatestr.Append("  </tr>\r\n");
  templatestr.Append("  <tr>\r\n");
  templatestr.Append("    <td height=\"25\" align=\"right\">QQ：</td>\r\n");
  templatestr.Append("    <td><input type=\"text\" name=\"qq\" id=\"qq\"></td>\r\n");
  templatestr.Append("  </tr>\r\n");
  templatestr.Append("  <tr>\r\n");
  templatestr.Append("    <td height=\"25\" align=\"right\">地址：</td>\r\n");
  templatestr.Append("    <td><input name=\"address\" type=\"text\" id=\"address\" size=\"35\"></td>\r\n");
  templatestr.Append("  </tr>\r\n");
  templatestr.Append("  <tr>\r\n");
  templatestr.Append("    <td height=\"25\" align=\"right\">&nbsp;</td>\r\n");
  templatestr.Append("    <td><label>\r\n");
  templatestr.Append("      <input type=\"submit\" name=\"button\" id=\"button\" value=\"提交\">\r\n");
  templatestr.Append("      <input type=\"reset\" name=\"button2\" id=\"button2\" value=\"重置\">\r\n");
  templatestr.Append("    </label></td>\r\n");
  templatestr.Append("  </tr>\r\n");
