<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="JoleYe.Web.Productinfo" %>
<%@ Import namespace="System.Data" %>
<%@ Import namespace="JoleYe.Model" %>
<%
      //此文件由JoleYe系统自动生成生成时间：2012-9-12 0:00:50
  ...
  templatestr.Append("</div>\r\n");
  templatestr.Append("<div class=\"heng\"></div>\r\n");
  templatestr.Append("<div class=\"tool bd\">目前位置 ：首页 >  <a href=\"productlist.aspx\">产品中心</a> > 产品浏览</div>\r\n");
  templatestr.Append("<div class=\"heng\"></div>\r\n");
  templatestr.Append("<div class=\"body bd\" id=\"bd\">\r\n");
  templatestr.Append("    <div class=\"left\" id=\"proinfo\">\r\n");
  templatestr.Append("        <div class=\"probox\">\r\n");
  templatestr.Append("            <div class=\"proimg\"><img src=\"");
  templatestr.Append(datarow["productImgUrl"]);
  templatestr.Append("\" width=\"320\" height=\"320\"></div>\r\n");
  templatestr.Append("            <div class=\"intro\">\r\n");
  templatestr.Append("            <ul>\r\n");
  templatestr.Append("                <li><span>产品名称：</span>");
  templatestr.Append(datarow["productname"]);
  templatestr.Append("</li>\r\n");
  templatestr.Append("                <li><span>价　　格：</span>");
  templatestr.Append(datarow["price"]);
  templatestr.Append("</li>\r\n");
  templatestr.Append("                <li><span>浏&nbsp;&nbsp;览&nbsp;&nbsp;量：</span>");
  templatestr.Append(datarow["hitnum"]);
  templatestr.Append("</li>\r\n");
  templatestr.Append("                <li class=\"buy\"><a href=\"#\" name=\"buy\" type=\"button\" value=\"\" title=\"购买\" id=\"go-buy\" ><b></b></a> <a  href=\"#\" name=\"car\" type=\"button\" value=\"\" id=\"go-addcar\" title=\"加入购物车\"><b></b></a></li>\r\n");
  templatestr.Append("            </ul>\r\n");
  templatestr.Append("            </div>\r\n");
  templatestr.Append("        </div>\r\n");
  templatestr.Append("        <div class=\"clear\"></div>\r\n");
  templatestr.Append("        <div class=\"procontent\">\r\n");
  templatestr.Append("        ");
  templatestr.Append(datarow["content"]);
  templatestr.Append("        </div>\r\n");
  templatestr.Append("    </div>\r\n");
