<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="JoleYe.Web.Down" %>
...
<%
  ...
  templatestr.Append("</div>\r\n");
  templatestr.Append("<div class=\"heng\"></div>\r\n");
  templatestr.Append("<div class=\"tool bd\">目前位置 ：首页 > 下载中心 </div>\r\n");
  templatestr.Append("<div class=\"body bd\">\r\n");
  templatestr.Append("	<div class=\"left box\">\r\n");
  templatestr.Append("		<div class=\"title\">下载中心</div>\r\n");
  templatestr.Append("                <div class=\"content\">");
  templatestr.Append(config_site["down"]);
  templatestr.Append("</div>\r\n");
  templatestr.Append("	</div>\r\n");
