<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="JoleYe.Web.Listinfo" %>
<%@ Import namespace="System.Data" %>
<%@ Import namespace="JoleYe.Model" %>
<%
      //此文件由JoleYe系统自动生成生成时间：2012-9-11 23:05:56
  ...
  templatestr.Append(time_format(dr["createDate"].ToString()));
