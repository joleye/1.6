<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="JoleYe.Web.Product" %>
<%@ Import namespace="System.Data" %>
<%@ Import namespace="JoleYe.Model" %>
<%
      //此文件由JoleYe系统自动生成生成时间：2012-9-11 23:05:42
  ...
  templatestr.Append("<h1>Ʒչʾ</h1>\r\n");
  templatestr.Append("<span>Products Show</span>\r\n");
  templatestr.Append("     </div>\r\n");
  templatestr.Append(" \r\n");
  ...
  templatestr.Append("      <div class=\"title\">ǰλã<a href=\"index.aspx\">ҳ</a> > Ʒչʾ</div>\r\n");
  templatestr.Append("      <ul class=\"cont\" id=\"product\">\r\n");
  foreach(ProductTypeInfo info in getprotypelist()){
  templatestr.Append("       <li><a href=\"search-");
  templatestr.Append(info["id"]);
  templatestr.Append(".aspx\" class=\"img\"><img src=\"");
  templatestr.Append(cpath_format(info["imgUrl.ToString(),"small""]));
  templatestr.Append("\" /></a><br /><span><a href=\"search-");
  templatestr.Append(info["id"]);
  templatestr.Append(".aspx\">");
  templatestr.Append(info["typeName"]);
  templatestr.Append("</a></span>\r\n");
  templatestr.Append("<select class=\"select\" name=\"sel\" id=\"selecttype\" onchange=\"gourl(this);\">\r\n");
  templatestr.Append("<option value=\"-1\">ѡϵвƷ</option>\r\n");
  foreach(DataRow drs in get_typelist_small(info.id.ToString()).Rows){
  templatestr.Append("<option value=\"");
  templatestr.Append(drs["id"]);
  templatestr.Append("\">");
  templatestr.Append(drs["typeName"]);
  templatestr.Append("</option>\r\n");
  }
  templatestr.Append("</select>\r\n");
  templatestr.Append("</li>\r\n");
  }
  templatestr.Append("      </ul>\r\n");
  templatestr.Append("<div class=\"pageBox\">");
  templatestr.Append(pageBox);
  templatestr.Append("</div>\r\n");
  templatestr.Append("    </div>\r\n");
  templatestr.Append("  </div>\r\n");
  templatestr.Append("</div>\r\n");
