<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="JoleYe.Web.Login" %>
...
<%
  ...
  templatestr.Append("</div>\r\n");
  templatestr.Append("<div class=\"heng\"></div>\r\n");
  templatestr.Append("<div class=\"tool bd\">目前位置 ：首页 > 用户登陆</div>\r\n");
  templatestr.Append("<div class=\"heng\"></div>\r\n");
  templatestr.Append("<div class=\"body bd\">\r\n");
  templatestr.Append("	<div class=\"left box\">\r\n");
  templatestr.Append("	    <div class=\"title\">用户登陆</div>\r\n");
  templatestr.Append("	    <div class=\"content\">\r\n");
  templatestr.Append("<form action=\"\" method=\"post\" class=\"form\">\r\n");
  templatestr.Append("  <table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" class=\"tb\">\r\n");
  templatestr.Append("    <tr>\r\n");
  templatestr.Append("      <td height=\"25\" align=\"right\">用户名：</td>\r\n");
  templatestr.Append("      <td><label>\r\n");
  templatestr.Append("        <input name=\"username\" type=\"text\" id=\"username\" size=\"20\">\r\n");
  templatestr.Append("      </label></td>\r\n");
  templatestr.Append("    </tr>\r\n");
  templatestr.Append("    <tr>\r\n");
  templatestr.Append("      <td height=\"25\" align=\"right\">密码：</td>\r\n");
  templatestr.Append("      <td><label>\r\n");
  templatestr.Append("        <input name=\"password\" type=\"password\" id=\"password\" size=\"20\">\r\n");
  templatestr.Append("      ");
  templatestr.Append(err_text);
  templatestr.Append("</label></td>\r\n");
  templatestr.Append("    </tr>\r\n");
  templatestr.Append("    <tr>\r\n");
  templatestr.Append("      <td height=\"25\">&nbsp;</td>\r\n");
  templatestr.Append("      <td><label>\r\n");
  templatestr.Append("        <input type=\"submit\" name=\"button\" id=\"button\" value=\"登陆\">\r\n");
  templatestr.Append("        <input type=\"reset\" name=\"button2\" id=\"button2\" value=\"重置\">\r\n");
  templatestr.Append("      </label><a href=\"account/qq_login.aspx\" class=\"qq_login\" title=\"QQ登陆\"><img src=\"");
  templatestr.Append(WEBPATH);
  templatestr.Append(TEMPLATEPATH);
  templatestr.Append("/images/qq_login.png\" /></a></td>\r\n");
  templatestr.Append("    </tr>\r\n");
