<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="JoleYe.Web.Search" %>
...
<%
  ...
  templatestr.Append("      <ul class=\"cont\" id=\"productlist\">\r\n");
  foreach(ProductInfo info in search()){
  templatestr.Append("       <li><a href=\"productinfo-");
  templatestr.Append(info["Id"]);
  templatestr.Append(".aspx\" class=\"img\"><img src=\"");
  templatestr.Append(cpath_format(info["productImgUrl.ToString(),"136""]));
  templatestr.Append("\" /></a><span><a href=\"productinfo-");
  templatestr.Append(info["Id"]);
  templatestr.Append(".aspx\">");
  templatestr.Append(info["productName"]);
  templatestr.Append("</a></span></li>\r\n");
  }
  templatestr.Append("      </ul>\r\n");
