<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="JoleYe.Web.Productlist" %>
...
<%
  ...
  templatestr.Append("</div>\r\n");
  templatestr.Append("<div class=\"heng\"></div>\r\n");
  templatestr.Append("<div class=\"tool bd\">目前位置 ：首页 >  产品中心</div>\r\n");
  templatestr.Append("<div class=\"heng\"></div>\r\n");
  templatestr.Append("<div class=\"body bd\">\r\n");
  templatestr.Append("<ul class=\"prolist\">\r\n");
  foreach(DataRow dr in get_list().Rows){
  templatestr.Append("    <li>\r\n");
  templatestr.Append("        <span><a href=\"productinfo-");
  templatestr.Append(dr["id"]);
  templatestr.Append(".aspx\"><img src=\"");
  templatestr.Append(tothumbimg_format(dr["productimgUrl"].ToString()));
  templatestr.Append("\" /></a></span>\r\n");
  templatestr.Append("    <h1><a href=\"productinfo-");
  templatestr.Append(dr["id"]);
  templatestr.Append(".aspx\">");
  templatestr.Append(dr["productName"]);
  templatestr.Append("</a></h1>\r\n");
  templatestr.Append("    </li>\r\n");
  }
  templatestr.Append("</ul>\r\n");
