<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="JoleYe.Web.Buy" %>
...
<%
  ...
  templatestr.Append("</div>\r\n");
  templatestr.Append("<div class=\"heng\"></div>\r\n");
  templatestr.Append("<div class=\"tool bd\">目前位置 ：<a href=\"index.aspx\">首页</a> &gt; ");
  templatestr.Append(pagetitle);
  templatestr.Append("</div>\r\n");
  templatestr.Append("<div class=\"heng\"></div>\r\n");
  templatestr.Append("<div class=\"body bd\">\r\n");
  templatestr.Append("	<div class=\"left box\">\r\n");
  templatestr.Append("	    <div class=\"title\"></div>\r\n");
  templatestr.Append("	    <div class=\"content\">\r\n");
  templatestr.Append("          <table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n");
  templatestr.Append("            <tr>\r\n");
  templatestr.Append("              <td>收货地址： </td>\r\n");
  templatestr.Append("              <td>&nbsp;</td>\r\n");
  templatestr.Append("              <td>&nbsp;</td>\r\n");
  templatestr.Append("            </tr>\r\n");
  templatestr.Append("            <tr>\r\n");
  templatestr.Append("              <td>其他收货地址：</td>\r\n");
  templatestr.Append("              <td><label for=\"textfield\"></label>\r\n");
  templatestr.Append("                <p>收件人：\r\n");
  templatestr.Append("                  <input type=\"text\" name=\"textfield\" id=\"textfield\" />\r\n");
  templatestr.Append("                </p>\r\n");
  templatestr.Append("              <p>地址：\r\n");
  templatestr.Append("                <label for=\"textfield2\"></label>\r\n");
  templatestr.Append("                <input type=\"text\" name=\"textfield2\" id=\"textfield2\" />\r\n");
  templatestr.Append("</p>\r\n");
  templatestr.Append("              <p>邮编：\r\n");
  templatestr.Append("                <label for=\"textfield3\"></label>\r\n");
  templatestr.Append("                <input type=\"text\" name=\"textfield3\" id=\"textfield3\" />\r\n");
  templatestr.Append("              </p>\r\n");
  templatestr.Append("              <p>电话：\r\n");
  templatestr.Append("                <label for=\"textfield4\"></label>\r\n");
  templatestr.Append("                <input type=\"text\" name=\"textfield4\" id=\"textfield4\" />\r\n");
  templatestr.Append("              </p>\r\n");
  templatestr.Append("              <p>手机：\r\n");
  templatestr.Append("                <label for=\"textfield5\"></label>\r\n");
  templatestr.Append("                <input type=\"text\" name=\"textfield5\" id=\"textfield5\" />\r\n");
  templatestr.Append("              </p></td>\r\n");
  templatestr.Append("              <td>&nbsp;</td>\r\n");
  templatestr.Append("            </tr>\r\n");
  templatestr.Append("            <tr>\r\n");
  templatestr.Append("              <td>&nbsp;</td>\r\n");
  templatestr.Append("              <td><label for=\"button\"></label>\r\n");
  templatestr.Append("                <label for=\"button2\"></label>\r\n");
  templatestr.Append("                <input type=\"submit\" name=\"button2\" id=\"button2\" value=\"继续购物\" />\r\n");
  templatestr.Append("                <input type=\"submit\" name=\"button\" id=\"button\" value=\"去结算\" /></td>\r\n");
  templatestr.Append("              <td>&nbsp;</td>\r\n");
  templatestr.Append("            </tr>\r\n");
