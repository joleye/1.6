<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="JoleYe.Web.Member" %>
...
<%
  ...
  templatestr.Append("        <a href=\"userinfo.aspx\">用户资料</a> <a href=\"mgrorder.aspx\">订单管理</a> <a href=\"member.aspx?act=mess\">留言管理</a>\r\n");
  templatestr.Append("                <form action=\"\" method=\"post\">\r\n");
  templatestr.Append("                \r\n");
